...
client = boto3.client('ec2')       # without the profile it will take default user
...
# the responce is Reservations [ ]
#            within Reservations we have a list of instances
#            The Instances list contains all the instance specific details
#
''''
'Instances': [
                {
...
for reservation in resp['Reservations']:
    for instance in reservation['Instances']:
        ...
        print("Image Id           : {} ".format(instance['ImageId'     ]))
        print("Instance Type      : {} ".format(instance['InstanceType']))
        print("Monitoring State   : {} ".format(instance['Monitoring']['State']))
